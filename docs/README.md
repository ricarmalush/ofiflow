...
| [009](./adr/ADR-009-seguridad-base.md) | Línea base de seguridad (Secure by Design) | Propuesto |
...
| [004-security-hardening](./specs/004-security-hardening/spec.md) | Línea base de seguridad (implementa ADR-009) | Borrador |
